    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-400">Picks you're hitting or tracking</p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          <motion.div
            ...
            className="glass-strong p-3 sm:p-4 rounded-xl"
          >
            <div className="text-xl sm:text-2xl font-bold text-white mb-0.5 sm:mb-1">{stats.total}</div>
          ...
          <motion.div
            ...
            className="glass-strong p-3 sm:p-4 rounded-xl border border-green-500/20"
          >
            <div className="text-xl sm:text-2xl font-bold text-green-400 mb-0.5 sm:mb-1">{stats.hit}</div>
            <div className="text-xs sm:text-sm text-gray-400">Hitting</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="glass-strong p-3 sm:p-4 rounded-xl border border-blue-500/20"
          >
            <div className="text-xl sm:text-2xl font-bold text-blue-400 mb-0.5 sm:mb-1">{stats.track}</div>
          ...
          >
            ...
            <div className="text-xs sm:text-sm text-gray-400">Won</div>
          </motion.div>
        </div>
        ...
        <div className="flex gap-2 mb-4 sm:mb-6">
          {['all', 'hit', 'track'].map((tab) => (
            <button
              ...
              className={`flex-1 sm:flex-initial px-4 sm:px-6 py-2 text-sm rounded-lg font-medium transition-all
                ${filter === tab 
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <Loader2 className="w-6 h-6 sm:w-8 sm:h-8 animate-spin text-green-400" />
          </div>
          ...
          >
            <Target className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 text-gray-700" />
            <h3 className="text-lg sm:text-xl font-bold text-gray-500 mb-2">No Bets Yet</h3>
